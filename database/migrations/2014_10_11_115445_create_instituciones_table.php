...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('instituciones', function (Blueprint $table) {
            ...
            $table->smallInteger('tieneSfl')->nullable();/* referencia 1(SI) o 2 (No)*/
            ...
            //Cerco
            $table->smallInteger('tieneCerco')->nullable();/* referencia 1(SI) o 2 (No)*/
            ...
            //Recreacion
            $table->smallInteger('requiereRecreacion')->nullable();/* referencia 1(SI) o 2 (No)*/
            $table->smallInteger('tipoRecreacion')->nullable();/* referencia de la tabla maestro*/

            //Datos Servicios
            //Intenet
            $table->smallInteger('tieneIntenet')->nullable();/* referencia 1(SI) o 2 (No)*/
            ...
            //Luz
            $table->smallInteger('tieneLuz')->nullable();/* referencia 1(SI) o 2 (No)*/
            ...
            //Agua
            $table->smallInteger('tieneAgua')->nullable();/* referencia 1(SI) o 2 (No)*/
            ...
            //Desague
            $table->smallInteger('tieneDesague')->nullable();/* referencia 1(SI) o 2 (No)*/
            ...
            //Reserva
            $table->smallInteger('tieneReserva')->nullable();/* referencia 1(SI) o 2 (No)*/
            ...
            //Vigilancia
            $table->smallInteger('tieneVigilancia')->nullable();/* referencia 1(SI) o 2 (No)*/
