                ...
                <JetTable class="mb-6">
                  ...
                  <template #row>
                    <tr
                      ...
                      "
                      v-for="(m, index) in asistencia.data"
                      :key="m.id"
                    >
                      ...
                      <td class="px-4 py-1">
                        <div class="flex items-center space-x-4 text-sm">
                          ...
                          <Link
                            ...
                            type="button"
                            :href="
                              route('asistencia.edit', { asistencium: m })
                            "
                          >
                            <button type="button">
                              <svg
                    ...
                    <tr v-if="asistencia.data.length === 0">
                  ...
                  <template #pagination>
                    <JetPagination
                      :links="asistencia.links"
                      :total="asistencia.total"
                      :to="asistencia.to"
                      :from="asistencia.from"
                    />
                  </template>
                </JetTable>
              </div>
  ...
  watch: {
    form: {
      ...
      handler: throttle(function () {
        this.$inertia.get(route("asistencia.index"), this.form, {
          preserveState: true,
        });
      }, 150),
    },
