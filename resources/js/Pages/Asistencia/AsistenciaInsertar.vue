                    ...
                    >
                            ...
                            >
                              <div>
                                ...
                                >
                                  ...
                                  >
                                    <p>
                                      Porfavor ingresar la asistencia de niños de
                                      3 años.
                                    </p>
                                    <svg
                                      class="
                      ...
                      >
                        ...
                        >
                          ...
                          <div class="flex flex-col md:flex-row">
                            <!-- Alumnos de primero a tercer grado de primaria-->
                            <div
                              class="grid grid-cols-1 md:grid-cols-3 md:gap-8"
                            >
                              <div>
                                ...
                                >
                                  ...
                                  >
                                    <p>
                                      Porfavor ingresar la asistencia de alumnos
                                      de primer grado.
                                    </p>
                                    <svg
                                      class="
                          ...
                          <div class="flex flex-col md:flex-row">
                            <!-- Alumnos de cuarto a sexto grado de primaria-->
                            <div
                              class="grid grid-cols-1 md:grid-cols-3 md:gap-8"
                            >
                              <div>
                      ...
                      >
                        ...
                        <!-- TITULO EDUCACION SECUNDARIA-->
                              ...
                              <div>
                                ...
                                >
                                  ...
                                  <JetInput
                                    ...
                                    class="mt-1 block w-full"
                                    autofocus
                                    v-model="form.PrimeroSecundaria"
                                    placeholder="Ingresar Asistencia"
                                    @keypress="SoloNumeros($event)"
                                    :class="{
                                      'border-red-300 focus:border-red-300 focus:ring focus:ring-red-200':
                              ...
                              <div>
                                ...
                                >
                                  ...
                                  <JetInput
                                    ...
                                    class="mt-1 block w-full"
                                    autofocus
                                    v-model="form.SegundoSecundaria"
                                    placeholder="Ingresar Asistencia"
                                    @keypress="SoloNumeros($event)"
                                    :class="{
                                      'border-red-300 focus:border-red-300 focus:ring focus:ring-red-200':
                              ...
                              <div>
                                ...
                                >
                                  ...
                                  <JetInput
                                    ...
                                    class="mt-1 block w-full"
                                    autofocus
                                    v-model="form.TerceroSecundaria"
                                    placeholder="Ingresar Asistencia"
                                    @keypress="SoloNumeros($event)"
                                    :class="{
                                      'border-red-300 focus:border-red-300 focus:ring focus:ring-red-200':
                          ...
                          <!-- FORMULARIO DE CUARTO A QUINTO SECUNDARIA-->
                          <div class="flex flex-col md:flex-row">
                            <div
                              class="grid grid-cols-1 md:grid-cols-3 md:gap-8"
                            >
                    ...
                    >
                              ...
                              <div>
                                ...
                                >
                                  ...
                                  <JetInput
                                    ...
                                    class="mt-1 block w-full"
                                    autofocus
                                    v-model="form.EspecialCuatroAnos"
                                    placeholder="Ingresar Asistencia"
                                    @keypress="SoloNumeros($event)"
                                    :class="{
                                      'border-red-300 focus:border-red-300 focus:ring focus:ring-red-200':
                              ...
                              <div>
                                ...
                                >
                                  ...
                                  <JetInput
                                    ...
                                    class="mt-1 block w-full"
                                    autofocus
                                    v-model="form.EspecialCincoAnos"
                                    placeholder="Ingresar Asistencia"
                                    @keypress="SoloNumeros($event)"
                                    :class="{
                                      'border-red-300 focus:border-red-300 focus:ring focus:ring-red-200':
                      ...
                      >
                        ...
                        <!-- TITULO EDUCACION PRIMARIA-->
                          ...
                          <!-- FORMULARIO PRIMERO A TERCER GRADO PRIMARIA-->
                          <div class="flex flex-col md:flex-row">
                            <div
                              class="grid grid-cols-1 md:grid-cols-3 md:gap-8"
                            >
                            <div>
                                ...
                                >
                                  ...
                                  <JetInput
                                    ...
                                    class="mt-1 block w-full"
                                    autofocus
                                    v-model="form.EspecialPrimerGrado"
                                    placeholder="Ingresar Asistencia"
                                    @keypress="SoloNumeros($event)"
                                    :class="{
                                      'border-red-300 focus:border-red-300 focus:ring focus:ring-red-200':
                              ...
                              <div>
                                ...
                                >
                                  ...
                                  <JetInput
                                    ...
                                    class="mt-1 block w-full"
                                    autofocus
                                    v-model="form.EspecialSegundoGrado"
                                    placeholder="Ingresar Asistencia"
                                    @keypress="SoloNumeros($event)"
                                    :class="{
                                      'border-red-300 focus:border-red-300 focus:ring focus:ring-red-200':
                              ...
                              <div>
                                ...
                                >
                                  ...
                                  <JetInput
                                    ...
                                    class="mt-1 block w-full"
                                    autofocus
                                    v-model="form.EspecialTercerGrado"
                                    placeholder="Ingresar asistencia"
                                    @keypress="SoloNumeros($event)"
                                    :class="{
                                      'border-red-300 focus:border-red-300 focus:ring focus:ring-red-200':
                          ...
                          <!-- FORMULARIO DE CUARTO A SEXTO PRIMARIA-->
                          <div class="flex flex-col md:flex-row">
                            <div
                              class="grid grid-cols-1 md:grid-cols-3 md:gap-8"
                            >
                              <div>
                                ...
                                >
                                  ...
                                  <JetInput
                                    ...
                                    class="mt-1 block w-full"
                                    autofocus
                                    v-model="form.EspecialCuartoGrado"
                                    placeholder="Ingresar Asistencia"
                                    @keypress="SoloNumeros($event)"
                                    :class="{
                                      'border-red-300 focus:border-red-300 focus:ring focus:ring-red-200':
                              ...
                              <div>
                                ...
                                >
                                  ...
                                  <JetInput
                                    ...
                                    class="mt-1 block w-full"
                                    autofocus
                                    v-model="form.EspecialQuintoGrado"
                                    placeholder="Ingresar Asistencia"
                                    @keypress="SoloNumeros($event)"
                                    :class="{
                                      'border-red-300 focus:border-red-300 focus:ring focus:ring-red-200':
                              ...
                              <div>
                                ...
                                >
                                  ...
                                  <JetInput
                                    ...
                                    class="mt-1 block w-full"
                                    autofocus
                                    v-model="form.EspecialSextoGrado"
                                    placeholder="Ingresar Asistencia"
                                    @keypress="SoloNumeros($event)"
                                    :class="{
                                      'border-red-300 focus:border-red-300 focus:ring focus:ring-red-200':
                      ...
                      >
                        ...
                        <!-- TITULO EDUCACION SECUNDARIA -->
                          ...
                          <!-- FORMULARIO PRIMERO A TERCERO SECUNDARIA-->
                          <div class="flex flex-col md:flex-row">
                            <div
                              class="grid grid-cols-1 md:grid-cols-3 md:gap-8"
                            >
                              <div>
                                ...
                                >
                                  ...
                                  <JetInput
                                    ...
                                    class="mt-1 block w-full"
                                    autofocus
                                    v-model="form.EspecialPrimeroSecundaria"
                                    placeholder="Ingresar Asistencia"
                                    @keypress="SoloNumeros($event)"
                                    :class="{
                                      'border-red-300 focus:border-red-300 focus:ring focus:ring-red-200':
                              ...
                              <div>
                                ...
                                >
                                  ...
                                  <JetInput
                                    ...
                                    class="mt-1 block w-full"
                                    autofocus
                                    v-model="form.EspecialSegundoSecundaria"
                                    placeholder="Ingresar Asistencia"
                                    @keypress="SoloNumeros($event)"
                                    :class="{
                                      'border-red-300 focus:border-red-300 focus:ring focus:ring-red-200':
                              ...
                              <div>
                                ...
                                >
                                  ...
                                  <JetInput
                                    ...
                                    class="mt-1 block w-full"
                                    autofocus
                                    v-model="form.EspecialTerceroSecundaria"
                                    placeholder="Ingresar Asistencia"
                                    @keypress="SoloNumeros($event)"
                                    :class="{
                                      'border-red-300 focus:border-red-300 focus:ring focus:ring-red-200':
                              ...
                              <div>
                                ...
                                >
                                  ...
                                  <JetInput
                                    ...
                                    class="mt-1 block w-full"
                                    autofocus
                                    v-model="form.EspecialCuartoSecundaria"
                                    placeholder="Ingresar Asistencia"
                                    @keypress="SoloNumeros($event)"
                                    :class="{
                                      'border-red-300 focus:border-red-300 focus:ring focus:ring-red-200':
                              ...
                              <div>
                                ...
                                >
                                  ...
                                  <JetInput
                                    ...
                                    class="mt-1 block w-full"
                                    autofocus
                                    v-model="form.EspecialQuintoSecundaria"
                                    placeholder="Ingresar Asistencia"
                                    @keypress="SoloNumeros($event)"
                                    :class="{
                                      'border-red-300 focus:border-red-300 focus:ring focus:ring-red-200':
                              ...
                              <div>
                                ...
                                >
                                  ...
                                  <JetInput
                                    ...
                                    class="mt-1 block w-full"
                                    autofocus
                                    v-model="form.InicialPrimerGrado"
                                    placeholder="Ingresar Asistencia"
                                    @keypress="SoloNumeros($event)"
                                    :class="{
                                      'border-red-300 focus:border-red-300 focus:ring focus:ring-red-200':
                                  ...
                                  >
                                    <p>
                                      Porfavor ingresar la asistencia de alumnos del
                                      primer grado.
                                    </p>
                                    <svg
                                      class="
                              ...
                              <div>
                                ...
                                >
                                  ...
                                  <JetInput
                                    ...
                                    class="mt-1 block w-full"
                                    autofocus
                                    v-model="form.InicialSegundoGrado"
                                    placeholder="Ingresar Asistencia"
                                    @keypress="SoloNumeros($event)"
                                    :class="{
                                      'border-red-300 focus:border-red-300 focus:ring focus:ring-red-200':
                                  ...
                                  >
                                    <p>
                                      Porfavor ingresar la asistencia de alumnos de
                                      segundogrado.
                                    </p>
                                    <svg
                                      class="
                              ...
                              <div>
                                ...
                                >
                                  ...
                                  <JetInput
                                    ...
                                    class="mt-1 block w-full"
                                    autofocus
                                    v-model="form.IntermedioPrimerGrado"
                                    placeholder="Ingresar Asistencia"
                                    @keypress="SoloNumeros($event)"
                                    :class="{
                                      'border-red-300 focus:border-red-300 focus:ring focus:ring-red-200':
                              ...
                              <div>
                                ...
                                >
                                  ...
                                  <JetInput
                                    ...
                                    class="mt-1 block w-full"
                                    autofocus
                                    v-model="form.IntermedioSegundoGrado"
                                    placeholder="Ingresar Asistencia"
                                    @keypress="SoloNumeros($event)"
                                    :class="{
                                      'border-red-300 focus:border-red-300 focus:ring focus:ring-red-200':
                              ...
                              <div>
                                ...
                                >
                                  ...
                                  <JetInput
                                    ...
                                    class="mt-1 block w-full"
                                    autofocus
                                    v-model="form.IntermedioTercerGrado"
                                    placeholder="Ingresar Asistencia"
                                    @keypress="SoloNumeros($event)"
                                    :class="{
                                      'border-red-300 focus:border-red-300 focus:ring focus:ring-red-200':
                              ...
                              <div>
                                ...
                                >
                                  ...
                                  <JetInput
                                    ...
                                    class="mt-1 block w-full"
                                    autofocus
                                    v-model="form.AvanzadoPrimerGrado"
                                    placeholder="Ingresar Asistencia"
                                    @keypress="SoloNumeros($event)"
                                    :class="{
                                      'border-red-300 focus:border-red-300 focus:ring focus:ring-red-200':
                              ...
                              <div>
                                ...
                                >
                                  ...
                                  <JetInput
                                    ...
                                    class="mt-1 block w-full"
                                    autofocus
                                    v-model="form.AvanzadoSegundoGrado"
                                    placeholder="Ingresar Asistencia"
                                    @keypress="SoloNumeros($event)"
                                    :class="{
                                      'border-red-300 focus:border-red-300 focus:ring focus:ring-red-200':
                              ...
                              <div>
                                ...
                                >
                                  ...
                                  <JetInput
                                    ...
                                    class="mt-1 block w-full"
                                    autofocus
                                    v-model="form.AvanzadoTercerGrado"
                                    placeholder="Ingresar Asistencia"
                                    @keypress="SoloNumeros($event)"
                                    :class="{
                                      'border-red-300 focus:border-red-300 focus:ring focus:ring-red-200':
                              ...
                              <div>
                                ...
                                >
                                  ...
                                  <JetInput
                                    ...
                                    class="mt-1 block w-full"
                                    autofocus
                                    v-model="form.AvanzadoCuartoGrado"
                                    placeholder="Ingresar Asistencia"
                                    @keypress="SoloNumeros($event)"
                                    :class="{
                                      'border-red-300 focus:border-red-300 focus:ring focus:ring-red-200':
                                  ...
                                  >
                                    <p>
                                      Porfavor ingresar la cantidad de alumnos
                                      de cuarto grado.
                                    </p>
                                    <svg
                                      class="
