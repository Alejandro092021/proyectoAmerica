              ...
              >
                ...
                <JetTable class="mb-6">
                  <template #col>
                    ...
                    <th  class="px-2 py-3 text-center">Especialidad</th>
                      ...
                      <td  class="px-4 py-1">
                        <span
                          class="
                            ...
                            rounded-full
                          "
                          v-if="m.especialidad == 'Comunicacion'"
                          >{{ m.especialidad }}</span
                        >
                        <span
                          class="
                            ...
                            rounded-full
                          "
                          v-if="m.especialidad == 'Matematica'"
                          >{{ m.especialidad }}</span
                        >
                        <span
                          class="
                        ...
                        <span
                          class="
                            ...
                            rounded-full
                          "
                          v-if="m.especialidad == 'Ciencias Sociales'"
                          >{{ m.especialidad }}</span
                        >
                        <span
                          class="
                            ...
                            rounded-full
                          "
                          v-if="m.especialidad == 'Ciencia y Tecnologia'"
                          >{{ m.especialidad }}</span
                        >
                        <span
                          class="
                            ...
                            rounded-full
                          "
                          v-if="m.especialidad == null"
                          >vacio</span
                        >
                      </td>
                      <td class="px-4 py-1 text-black" >{{ m.cantidad }}</td>
  ...
  watch: {
    form: {
      ...
      handler: throttle(function () {
        this.$inertia.get(route("docente.index"), this.form, {
          preserveState: true,
        });
      }, 150),
    },
