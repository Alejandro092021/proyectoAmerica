              ...
              >
                <form id="formGuardar" @submit.prevent="GuardarUsuario">
                  ...
                  <div class="grid grid-cols-1 md:grid-cols-3 md:gap-8">
                    ...
                    <!-- Tipo de Modalidad -->
                    <div>
                      <JetLabel for="Modalidad" value="Modalidad:" />
                      ...
                      >
                        ...
                        <option
                          v-for="(tm, index) in tipomodalidad"
                          :key="index"
                          :value="tm.campo"
                        >
                          {{ tm.campo }}
                    ...
                    <!-- Tipo Modulo -->
                    <div>
                      <JetLabel for="Modulo" value="Modulo:" />
                    ...
                    <!-- Tipo de Estudio -->
                    <div>
                      <JetLabel for="TipoEstudio" value="Tipo de Estudio:" />
                  ...
                  <!-- Nivel -- Grado -- Bimestre -->
                  <div class="grid grid-cols-1 md:grid-cols-3 md:gap-8">
                    <!-- Nivel -->
                    <div>
                      <JetLabel for="Nivel" value="Nivel:" />
                    ...
                    <!-- Grado -->
                    <div>
                      <JetLabel for="Grado" value="Grado:" />
                    ...
                    <div >
                      ...
                      <div
                        ...
                        class="text-xs px-2 py-2 text-red-400 dark:text-red-400"
                      >
                        Este especialidad ya ha sido registrado
                      </div>
                      <div
                        v-for="(error, index) of v$.form.especialidad.$errors"
                        :key="index"
                      >
                        <div
                          class="
...
export default defineComponent({
  ...
  data() {
    return {
      ...
      form: this.$inertia.form({
        ...
        id: this.$props.matriculado.id,

        modalidad: this.$props.matriculado.modalidad,
        modulo: this.$props.matriculado.modulo,
        tipoestudio: this.$props.matriculado.educacion,
        nivel: this.$props.matriculado.nivel,
        grado: this.$props.matriculado.grado,
        especialidad: this.$props.matriculado.especialidad,

        cantidad: this.$props.matriculado.cantidad,
        idusuario: this.$page.props.user.id,
        usuarioeditor: this.$page.props.user.name,
      }),
    };
  },
      ...
      form: {
        ...
        especialidad: {
          requiredIf: helpers.withMessage(
            "Este campo no puede estar vacío",
            requiredIf(() =>{
              return this.form.nivel == "Secundaria"
            })
          ),
          $autoDirty: true,
        },
  ...
  methods: {
    ...
    MostrarBimestre(event) {
      if (this.form.modulo == "Nivel de Logro") {
    ...
    GuardarUsuario() {
      this.form.post(
        this.route("docente.update", this.form.id),
            ...
            this.$notify(
              {
                ...
                type: "success",
                title: "Exíto",
                text: "Matriculados registrado correctamente",
              },
              2000
            );
          },
            ...
            this.$notify(
              {
                ...
                type: "error",
                title: "Error",
                text: "Matriculados no registrado",
              },
              2000
            );
          },
