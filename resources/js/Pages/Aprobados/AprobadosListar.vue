              ...
              >
                ...
                <JetTable class="mb-6">
                  <template #col>
                    ...
                    <th class="px-2 py-3 text-center">Bimestre</th>
                      ...
                      <td class="px-4 py-1">
                        <div class="flex items-center space-x-4 text-sm">
                          ...
                          <Link
                            ...
                            type="button"
                            :href="
                              route('aprobados.edit', { aprobado: m })
                            "
                          >
                            <button type="button">
                              <svg
  ...
  watch: {
    form: {
      ...
      handler: throttle(function () {
        this.$inertia.get(route("aprobados.index"), this.form, {
          preserveState: true,
        });
      }, 150),
    },
