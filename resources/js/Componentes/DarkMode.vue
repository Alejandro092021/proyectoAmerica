<template>
  <div class="w-full h-full flex flex-col justify-center items-center">
    <div class="flex justify-center items-center">
      <div
        class="w-10 h-6 flex items-center bg-gray-300 rounded-full mx-1 px-1 cursor-pointer"
        :class="{ 'dark:bg-gray-600': theme === 'dark' }"
        @click="toggleTheme"
      >
        <div
          class="bg-white w-4 h-4 rounded-full shadow-md transform transition duration-700 ease-out"
          :class="{ 'translate-x-4 dark:bg-gray-700': theme === 'dark' }"
        >
  ...
  methods: {
   ...
   /* computed: {
      thema() {
        ...
        let defaultTheme = userPrefersDark ? "dark" : "light";
